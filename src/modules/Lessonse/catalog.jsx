        ...
        <>
            <div className="lessons">
                ...
                <div className="lessons__items">
                    {catalogList.length > 0 &&
                        catalogList.map((item, index) => (
                            <div className="lessons__item item-lessons" key={index}>
                                <div className="item-lessons__name">{item.name}</div>
                    ...
                    <div className="lessons__item item-lessons" key={5}>
                        <div className="item-lessons__name"><span className="item-lessons__number">99</span> Название урока</div>

                        <div className="item-lessons__btns">
                            <a
                                className="item-lessons__edit"
                                href={`edit/2`}
                            >
                                <svg
                                    width="42"
