...
function StatisticsMany() {
    ...
    function CheckSetStaticSections(name) {
        console.log(name);
        // if (staticSections.length !== 0 && staticSections.includes(name)) {
        setStaticSections([])
        // } else {
        // setStaticSections([...staticSections, name])
        // }
    }
    ...
    return <>
        <div className="static-many static">
            <div className="static__carts">
                <div className="static__cart cart-static" onClick={() => CheckSetStaticSections('admin')}>
                ...
                <div className="static__cart cart-static" onClick={() => CheckSetStaticSections('users')}>
                    <div className="cart-static__icon">
            ...
            {/* {staticSections.length !== 0 || staticSections.includes('admin') && */}
            ...
            {/* {staticSections.length == 0 || staticSections.includes('users') && */}
            <div className="static__section">
                <div className="static__title">Доход от админов</div>
