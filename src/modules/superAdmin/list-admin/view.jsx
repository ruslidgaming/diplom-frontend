...
function ListAdmin() {
    ...
    const { search, isSearch, setSearch, searchedModel, apiListData, list } = listAdminModel
            ...
            {isSearch ?
                searchedModel.map((item, index) => {
                    return <div key={index} className="listadmin__item list-column__item">
                        <div className="listadmin__item-top">{item.companyName}</div>
                        <div className="listadmin__item-bottom">
                            <p className="listadmin__item-company">{item.surname + " " + item.name}</p>
